...
public static class DotNetMapPrompts
{
        ...
        [Description("Optional focus area, e.g. ordering, payments")] string? focus = null)
    {
        ...
        return $"""
            ...
            Workflow:
            1. Call get_status to confirm the DotNetMap index is current.
            ...
            Prefer DotNetMap tools over reading many source files. Stay within token budget; request detail only when needed.
            """;
    }
